...
void CustomtableWidget::appendRowData()
{
...
void CustomtableWidget::initFrame()
{
    clearContents();
    setColumnCount(10);
...
void CustomtableWidget::initFrozenFrame()
{
...
void CustomtableWidget::updateFrozenTableGeometry()
{
...
QModelIndex CustomtableWidget::moveCursor(QAbstractItemView::CursorAction cursorAction, Qt::KeyboardModifiers modifiers)
{
...
void CustomtableWidget::scrollTo(const QModelIndex &index, QAbstractItemView::ScrollHint hint)
{
    if (index.row() > 0)
